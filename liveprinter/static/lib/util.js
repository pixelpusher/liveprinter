...
(function (global) {
    ...
    global.makeIterator = makeIterator;
    ...
    global.makeMapping = makeMapping;
    ...
    const repeat = async (num, func) => {
        for (let i = 0; i < num; i++) {
            try {
                ...
                global.doError(e); // print GUI response
            }
        }
        return 1;
    };
